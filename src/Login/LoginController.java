...
import Animation.ColorfulSquares;
...
public class LoginController implements Initializable {
    ...
    private void loadMessenger() {
        try {
            ...
            Pane pane = FXMLLoader.load(getClass().getResource("/Messenger/Messenger.fxml"));
    ...
    private void loadRegistration() {
        try {
            Stage stage = new Stage();
            Pane pane = FXMLLoader.load(getClass().getResource("/Registration/Registration.fxml"));
            stage.setScene(new Scene(pane));
